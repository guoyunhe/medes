...
<div id="create-user" class="popup">
    ...
    <div class="popup-body">
        ...
        <div id="page-2" class="page active" data-page="2">
            ...
            <?php
            su_get_year_select(null, 'year_1', 'large');
            su_get_school_select(null, 'school_1', 'large');
            su_get_year_select(null, 'year_2', 'large');
            su_get_school_select(null, 'school_2', 'large');
            su_get_year_select(null, 'year_3', 'large');
            su_get_school_select(null, 'school_3', 'large');
            ?>
            <button class="next large">NEXT</button>
        </div>
